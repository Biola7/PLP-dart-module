void categorizeNumber(int number) {
  switch (number) {
    ...
    case 6: case 7: case 8: case 9: case 10:
      print(" $number : The number is small.");
      break;
    ...
    case 96: case 97: case 98: case 99: case 100:
      print(" $number :The number is medium.");
      break;

    default:
      if (number > 100) {
        print(" $number : The number is large.");
      } else {
        print(" $number : The number is out of range.");
      }
      break;
  }
}
